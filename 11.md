...
i = 'x';
```
Example: :eyes: const-not-really-a-const.c
...
*s2 = 'a';		// legal
```
Example: :eyes: const-and-pointers.c
...
Example: :eyes: identifier-name-space.c
...
```
Example: :eyes: complex-declaration.c
...
11100100
```
Solution: :eyes: print-in-binary.c
...
```
Example: :eyes: conv-and-prom-with-bitwise-ops.c
