...
Example: const-not-really-a-const.c
...
With "typedef", you create new data type _names_ for existing types.
Note that you do NOT create new data _types_ with typedef.  With
...
Example: identifier-name-space.c
...
So, ((338 & 978) == 272).	// == is of higher prority than &
...
Example: conv-and-prom-with-bitwise-ops.c

Assignment: rewrite print-in-binary.c using bitwise operators

Assignment: count 1 bits in a number (argv[1]).
