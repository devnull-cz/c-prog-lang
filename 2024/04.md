...
See e.g. :eyes: [whole-array.c example above (where only `-Wextra` gives some clue)](https://github.com/devnull-cz/c-prog-lang/blob/master/src/whole-array.c example above (where only `-Wextra` gives some clue))
