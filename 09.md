...
function `first`() in :eyes: [ptr-ptr-array.c is called for `ppa` and `ppb`.](https://github.com/devnull-cz/c-prog-lang/blob/master/src/ptr-ptr-array.c is called for `ppa` and `ppb`.)
