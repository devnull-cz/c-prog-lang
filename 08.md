...
- postfix operator has higher precedence than deref op however will be evaluated
...
code: :eyes: [struct-access-ptr.c](https://github.com/devnull-cz/c-prog-lang/blob/master/src/struct-access-ptr.c)
