...
- structure does not have to have a name, :eyes:
  [struct-unnamed.c](src/struct-unnamed.c)
	  ...
	  - one can even have an "anonymous structure", however that is a C11
	    extension, :eyes: [struct-anon.c](src/struct-anon.c)
...
:eyes: code: [animal-sort.c](src/animal-sort.c), [animals.h](src/animals.h),
...
:eyes: code: [flexible-array-member.c](src/flexible-array-member.c)
