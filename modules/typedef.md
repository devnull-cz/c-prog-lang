...
by the C standard itself are based on basic types.  For example, see
type names in the `/usr/include/sys/` directory on Unix systems.

It is possible to create new type names using type names created before, see
below.
