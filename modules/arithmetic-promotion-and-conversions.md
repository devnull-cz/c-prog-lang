...
We already mentiond some of this in an [Arithmetic type
conversions](/modules/modules/arithmetic-type-conversions.md) section but now we
...
So, the following are congruent, assigning the following numbers in an `unsigned
char` will result in:
