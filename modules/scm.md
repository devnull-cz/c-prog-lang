...
- keep all of your code somewhere.  Use a *distributed* source code management
  ...
  - never use *centralized* SCMs like [Subversion](https://subversion.apache.org/) or [CVS](https://en.wikipedia.org/wiki/Concurrent_Versions_System), unless you really
