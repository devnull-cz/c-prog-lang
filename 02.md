# The C Programming Language, class #2
#
# Feb 28, 2018
#
# by Jan
...
- reimplement fahr-to-cent.c using defines instead of white numbers
...
- logical AND and OR
	...
	- you do not need extra ()'s as || and && have higher priority than ==
	  and <, >, <=, >=, and !=.  We will learn more about operator priority
	  in later lectures.
...
- numbers and types
	...
	- hexadecimal numbers start with "0x" or "0X".  Eg. "0xFF", "0Xaa",
	  "0x13f", etc.
...
- write code that will read characters from a terminal and prints them out.
...
#
# Home assignment.  It's voluntary but writing code is the only way to learn a
