...
code: [struct-X.c](src/struct-X.c)
...
Code: [struct-reference.c](src/struct-reference.c)
...
Code: [struct-access.c](src/struct-access.c)
...
```
Code: [struct-init.c](src/struct-init.c)
...
Code: [struct-designated-init.c](src/struct-designated-init.c)
...
Code: [struct-animals.c](src/struct-animals.c),
...
code: [animal\_maxlegs.c](src/animal\_maxlegs.c), [maxlegs.c](src/maxlegs.c),
...
Code: [animal-sort.c](src/animal-sort.c), [animals.h](src/animals.h), [animal.h](src/animal.h)
...
code: [struct-common.c](src/struct-common.c)
...
code: [offsetof.c](src/offsetof.c)
...
code: [bitfield.c](src/bitfield.c)
...
code: [linked-list-free.c](src/linked-list-free.c)
...
code: [flexbile-array-member.c](src/flexbile-array-member.c)
...
:wrench: Task: consider this declaration:
```C
  union {
...
Code: [union-lowhigh.c](src/union-lowhigh.c)
